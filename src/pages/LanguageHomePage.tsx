...
import LessonProgress from '../ui/LessonProgress';
import AchievementModal from '../ui/AchievementModal';
import LanguageLevelCard from '../ui/LanguageLevelCard';
import DailyLanguageQuest from '../ui/DailyLanguageQuest';
import LessonTimer from '../ui/LessonTimer';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* User Level Card */}
        <LanguageLevelCard user={state.user} />
